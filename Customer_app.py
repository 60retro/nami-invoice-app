...
# 🎨 CSS แก้ไขสีตัวหนังสือ (สำคัญมาก!)
hide_streamlit_style = """
            ...
            .stSelectbox div[data-baseweb="select"] > div {
                border-color: #ff4b4b !important;      /* ขอบสีแดงอ่อน */
                background-color: #fff0f0 !important;  /* พื้นหลังสีชมพูจาง */
                color: #000000 !important;             /* 🟢 บังคับตัวหนังสือสีดำ */
            }
            
            /* บังคับตัวหนังสือข้างใน (span) ให้เป็นสีดำด้วย */
            .stSelectbox div[data-baseweb="select"] span {
                color: #000000 !important;
            }
            
            /* เปลี่ยนสีลูกศร Dropdown เป็นสีดำ */
...
# ==========================================
# 📝 ส่วนฟอร์มลูกค้า (UI ใหม่ + Fix CSS)
# ==========================================
...
# ==========================================
# 📍 ส่วนที่อยู่ (ปรับปรุง CSS Text Color)
# ==========================================
st.markdown("---")
