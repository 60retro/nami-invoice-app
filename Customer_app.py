...
# ==========================================
# 📍 ส่วนที่อยู่ (ปรับข้อความให้ชัดเจน)
# ==========================================
st.markdown("---")
...
if len(input_zip) == 5 and not thai_db.empty:
    ...
    if not results.empty:
        ...
        # 🟢 เปลี่ยนข้อความตรงนี้ตามที่ขอครับ
        final_options = ["👇 กรุณากดที่นี่เพื่อเลือกที่อยู่"] + options
